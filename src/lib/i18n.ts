...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    success: {
      ...
      subtitle:
        "Your personalized Wydaho Warrior Knife Check Assessment is ready to begin. In just minutes, you're going to uncover the exact patterns that have been keeping you stuck—and get a protocol built specifically to help you recover from burnout and rediscover your purpose as a chef-owner.",
      ...
      step2Text:
        "The AI will ask follow-up questions based on your answers to map your specific patterns with precision. There's no time limit—take breaks if you need them.",
  ...
  es: {
    ...
    consent: {
      welcome:
        "Bienvenido a la Evaluación Wydaho Warrior Knife Check para Chefs Agotados",
      ...
      privacyText:
        "Al continuar, consientes la recopilación y el procesamiento de tus respuestas con el propósito de generar tu protocolo personalizado. Tus datos están encriptados y almacenados de forma segura, y no serán compartidos con terceros.",
    ...
    success: {
      ...
      from: "De:",
      cantFind:
        "¿No lo encuentras? Revisa tu carpeta de spam o contacta soporte",
      whatHappensNext: "Qué Sigue",
      step1Title: "Haz clic en el enlace de tu correo",
      step1Text:
        "Tu evaluación personalizada está lista y esperando. Encuentra un espacio tranquilo donde puedas ser honesto y reflexivo. Por favor, elabora tanto como puedas sentir.",
      step2Title: "Completa tu evaluación (30 minutos)",
      step2Text:
        "La IA hará preguntas de seguimiento basadas en tus respuestas para mapear tus patrones específicos con precisión. No hay límite de tiempo—toma descansos si los necesitas.",
      step3Title: "Recibe tu protocolo (Inmediatamente después de completar)",
      step3Text:
        "Tu protocolo de transformación de 30 días personalizado será entregado a tu correo en el momento en que termines. Guárdalo. Consúltalo. Úsalo. Este es tu nuevo mapa de ruta potencial que puede llevar a una transformación de 30 años.",
    ...
    assessment: {
      ...
      invalidLink:
        "Este enlace de evaluación no es válido o ha expirado. Por favor, revisa tu correo electrónico para un enlace válido.",
      tryAgain: "Intentar de Nuevo",
      complete: "¡Evaluación Completa!",
      reportGenerating:
        "Tu informe de evaluación se generará en unos minutos y se enviará a tu correo electrónico.",
      reportSent:
        "Tu informe de evaluación personalizado ha sido generado y enviado a tu correo.",
      checkEmail:
        "📧 Revisa tu correo para tu protocolo personalizado de 30 días",
    },
    chat: {
      greeting: "Hola",
